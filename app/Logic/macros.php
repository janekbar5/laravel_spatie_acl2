...
/*
	HTML::macro('show_gravatar', function() {
	//$username = Auth::user()->name;	
	//$username = Auth::user()->name;
	if(Auth::user()->profile->logo_file != null){
	  $username = Auth::user()->profile->logo_file;
	  $image ="<img class=img-circle src=/".$username." width=30 />";
	  return $image;
	}else{
		echo "<img class=img-circle src=http://www.gravatar.com/avatar/3ff0a69ff382b8bb70b2618752bfdf41.jpg?s=80&d=mm&r=g width=30/>";
	}  
	//return $username;	
	});
*/	
	...
	if(Auth::user()->profile->logo_file != null){
	  ...
	  echo $image ="<img class=img-circle src=/user_logos/thumbs/".$username." width=30 />";	  
	}else{
		echo "<img class=img-circle src=http://www.gravatar.com/avatar/3ff0a69ff382b8bb70b2618752bfdf41.jpg?s=80&d=mm&r=g width=30/>";
	...
	HTML::macro('show_gravatar_100', function() {
	//$username = Auth::user()->name;	
	//$username = Auth::user()->name;
	if(Auth::user()->profile->logo_file != null){
	  ...
	  echo $image ="<img class=img-circle src=/user_logos/thumbs/".$username." width=100 />";	  
	}else{
		echo "<img class=img-circle src=http://www.gravatar.com/avatar/3ff0a69ff382b8bb70b2618752bfdf41.jpg?s=80&d=mm&r=g width=30/>";
